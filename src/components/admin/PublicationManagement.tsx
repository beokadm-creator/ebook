...
const PublicationManagement: React.FC = () => {
  ...
  const handleUploadContent = (confId: string, pubId: string, type: string) => {
    window.location.href = `/upload/${confId}?pubId=${pubId}&type=${type}`;
  };
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  <button
                    onClick={() => handleUploadContent(pub.conferenceId, pub.id!, pub.type)}
